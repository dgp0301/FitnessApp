...
CREATE TABLE IF NOT EXISTS `Follows` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Follows_Users1_idx` (`Followers_id` ASC) ,
...
-- Table `ExcerciseType`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ExcerciseType` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Excercise` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Excercise_ExcerciseType1_idx` (`ExcerciseType_id` ASC) ,
  INDEX `fk_Excercise_Workout1_idx` (`Workout_id` ASC) ,
  CONSTRAINT `fk_Excercise_ExcerciseType1`
    FOREIGN KEY (`ExcerciseType_id`)
    REFERENCES `ExcerciseType` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Excercise_Workout1`
